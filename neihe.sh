...
if [ $? -ne 0 ]; then
  ...
  apt-get install build-essential -y
    wget --no-check-certificate -qO '/tmp/linux-compiler-gcc-6-x86_4.9.65-3_amd64.deb' 'https://snapshot.debian.org/archive/debian/20180309T044028Z/pool/main/l/linux/linux-compiler-gcc-6-x86_4.9.65-3_amd64.deb'
  sleep 1
    wget --no-check-certificate -qO '/tmp/linux-kbuild-4.9_4.9.65-3_amd64.deb' 'https://snapshot.debian.org/archive/debian/20180309T044028Z/pool/main/l/linux/linux-kbuild-4.9_4.9.65-3_amd64.deb'
    sleep 1
    wget --no-check-certificate -qO '/tmp/linux-headers-4.9.0-4-common_4.9.65-3_all.deb' 'https://snapshot.debian.org/archive/debian/20180309T044028Z/pool/main/l/linux/linux-headers-4.9.0-4-common_4.9.65-3_all.deb'
    sleep 1
     wget --no-check-certificate -qO '/tmp/linux-headers-4.9.0-4-amd64_4.9.65-3_amd64.deb' 'https://snapshot.debian.org/archive/debian/20180309T044028Z/pool/main/l/linux/linux-headers-4.9.0-4-amd64_4.9.65-3_amd64.deb'
     sleep 1
     wget --no-check-certificate -qO '/tmp/linux-image-4.9.0-4-amd64_4.9.65-3_amd64.deb' 'https://snapshot.debian.org/archive/debian/20180309T044028Z/pool/main/l/linux/linux-image-4.9.0-4-amd64_4.9.65-3_amd64.deb'
     sleep 1
     dpkg -i '/tmp/linux-compiler-gcc-6-x86_4.9.65-3_amd64.deb'
     sleep 1
     dpkg -i '/tmp/linux-kbuild-4.9_4.9.65-3_amd64.deb'
     sleep 1
     dpkg -i '/tmp/linux-headers-4.9.0-4-common_4.9.65-3_all.deb'
     sleep 1
     dpkg -i '/tmp/linux-headers-4.9.0-4-amd64_4.9.65-3_amd64.deb'
     sleep 1
     dpkg -i '/tmp/linux-image-4.9.0-4-amd64_4.9.65-3_amd64.deb'
     sleep 1
    if [ $? -ne 0 ]; then
      exit 1
    fi
